...
Mscrm.FormInputControl.RadioGroupBehavior.getRadioDataValue = function(
		dataValue) {
	if (!IsNull(dataValue)) {
		var $v_0 = typeof dataValue;
		if (!IsNull($v_0))
			if ($v_0.toLowerCase() === Mscrm.TypeNames.booleanType)
				return dataValue;
			else if ($v_0.toLowerCase() === Mscrm.TypeNames.stringType) {
				var $v_1 = dataValue;
				if ($v_1.toLowerCase() === "checked")
					return true;
				else if ($v_1.length > 0)
					return Boolean.parse($v_1)
			}
	}
	return false
};
Mscrm.FormInputControl.RadioGroupBehavior.prototype = {
	...
	add_focus : function(value) {
		this.get_events().addHandler("RadioOnFocus", value)
	},
	remove_focus : function(value) {
		this.get_events().removeHandler("RadioOnFocus", value)
	},
	add_change : function(value) {
		this.get_events().addHandler("RadioOnChange", value)
	},
	remove_change : function(value) {
		this.get_events().removeHandler("RadioOnChange", value)
	},
	...
	get_isDirty : function() {
		return this.$4_4 !== this.$5_4()
	},
	get_dataXml : function() {
		var $v_0 = this.$5_4(), $v_1 = Mscrm.Utilities.emptyString;
		if (!IsNull($v_0))
			if (this.$0_4.length > 2)
				$v_1 = $v_0;
			else
				$v_1 = $v_0 ? "1" : "0";
	...
	set_disabled : function(value) {
		...
		for ( var $v_0 = 0; $v_0 < this.$0_4.length; $v_0++)
			this.$0_4[$v_0].disabled = value;
		!value && this.$8_4();
		return value
	},
	initialize : function() {
		...
		if (IsNull($v_0) || $v_0 !== "BulkEdit") {
			this.$4_4 = this.$5_4();
			this.get_element().DefaultValue = this.$4_4
		}
	},
	...
	dispose : function() {
		if (!IsNull(this.$0_4))
			for ( var $v_2 = this.$0_4.length, $v_3 = 0; $v_3 < $v_2; $v_3++) {
				!IsNull(this.$1_4) && this.$6_4
						&& $removeHandler(this.$0_4[$v_3], "click", this.$1_4);
				!IsNull(this.$2_4) && this.$7_4
						&& $removeHandler(this.$0_4[$v_3], "focus", this.$2_4)
			}
		this.$1_4 = null;
		this.$2_4 = null;
		this.$3_4 = null;
	...
	$8_4 : function() {
		for ( var $v_0 = this.$0_4.length, $v_1 = 0; $v_1 < $v_0; $v_1++) {
			...
			if (!IsNull($v_2) && $v_2.checked) {
				...
				if (!IsNull($v_3) && $v_3 === "BulkEdit")
					this.$0_4[$v_1].setAttribute("checked", false);
				else
					this.$3_4 = this.$0_4[$v_1]
			}
		}
		this.$6_4 = true
	},
	$B_4 : function() {
		for ( var $v_0 = this.$0_4.length, $v_1 = 0; $v_1 < $v_0; $v_1++)
			$addHandler(this.$0_4[$v_1], "focus", this.$2_4);
		this.$7_4 = true
	},
	$5_4 : function() {
		var $v_0 = this.$A_4();
		if (!IsNull($v_0)) {
			...
			if (IsNull($v_1)
					|| $v_1.toLowerCase() === Mscrm.TypeNames.booleanType)
				return $v_0 === "1";
			return $v_0
		}
		return null
	...
	$A_4 : function() {
		for ( var $v_0 = this.$0_4.length, $v_1 = 0; $v_1 < $v_0; $v_1++) {
			var $v_2 = this.$0_4[$v_1];
			if (!IsNull($v_2) && $v_2.checked)
				return this.$0_4[$v_1].getAttribute("value")
		}
		return null
	},
	$D_4 : function($p0) {
		var $v_0 = this.get_element().getAttribute("atype"), $v_1 = !IsNull($v_0) ? $v_0
				.toLowerCase()
				: Mscrm.Utilities.emptyString;
		if (IsNull($p0) && $v_1 !== Mscrm.TypeNames.stringType)
			$p0 = -1;
		else if (IsNull($p0) && $v_1 === Mscrm.TypeNames.stringType)
			$p0 = Mscrm.Utilities.emptyString;
		else if (!$v_1.length || $v_1 === Mscrm.TypeNames.booleanType) {
			var $v_3 = typeof $p0;
			if (!IsNull($v_3)
					&& $v_3.toLowerCase() !== Mscrm.TypeNames.booleanType) {
...
Mscrm.FormInputControl.RadioGroupBehavior.registerClass(
